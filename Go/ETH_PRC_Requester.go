...
func (r *ETHRPCRequester) GetTransactionByHash(txHash string) (model.Transaction_log, error) {
...
// 根据区块号，获取区块信息
func (r *ETHRPCRequester) GetBlockInfoByNumber(blockNumber *big.Int) (*model.Transaction_Block, error) {
	number := fmt.Sprintf("%#x", blockNumber)
	methodName := "eth_getBlockByNumber"
	fullBlock := model.Transaction_Block{}
...
// 根据区块 hash，获取区块信息
func (r *ETHRPCRequester) GetBlockInfoByHash(blockHash string) (*model.Transaction_Scan, error) {
